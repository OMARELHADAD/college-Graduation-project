      ...
      {isLoading ? (
        ...
        <div className="container">
          <span className="breadcrumbs">
            <Link to="/messages">Messages</Link> &gt; {data?.sellerId === currentUser.id ? data?.buyerId : data?.sellerId}
          </span>
          <div className="messages">
            {data && data.map((msg) => (
              <div key={msg._id} className={msg.senderId === currentUser.id ? "item owner" : "item"}>
                <img
                  src={msg.senderImage}
                  alt=""
                />
